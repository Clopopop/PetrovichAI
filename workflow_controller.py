...
class WorkflowController:
    ...
    def __init__(self, config: ConfigManager):
        ...
        self.SYSTEM_PROMPT_SHOULD_RESPOND = self.SYSTEM_PROMPT + (
            ...
            "Не отвечай на сообщение, если ты не добавляешь новых существенных данных в дискуссию. "
            "ВАЖНО: ты можешь отвечать на сообщение, только если к тебе обратились напрямую в рамках обсуждения "
            "текущей темы или к тебе обратились неявно, но ты уже участвовал в диалоге на эту тему. "
